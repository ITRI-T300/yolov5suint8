...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    /* @attach_Transpose_/model.24/Transpose/out0_0:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 85;
    attr.size[1] = 80;
    attr.size[2] = 80;
    ...
    attr.size[4] = 1;
    attr.dim_num = 5;
    attr.dtype.scale = 0.08530417829751968;
    attr.dtype.zero_point = 174;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_NORM_TENSOR(norm_tensor[1], attr, VSI_NN_TYPE_UINT8);

    /* @attach_Transpose_/model.24/Transpose_2/out0_2:out0 */
    memset( &attr, 0, sizeof( attr ) );
    attr.size[0] = 85;
    attr.size[1] = 20;
    attr.size[2] = 20;
    ...
    attr.size[4] = 1;
    attr.dim_num = 5;
    attr.dtype.scale = 0.08362185209989548;
